          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo site_url('admin/c_admin'); ?>"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo site_url('admin/prodi'); ?>"><i class="fa fa-circle-o"></i>prodi</a></li>
